...
class Input extends Component {
  ...
  componentWillReceiveProps(newProps) {
    ...
    if (this.state.borderColor !== newProps.borderColor) {
        this.setState({borderColor : newProps.borderColor})
    }
  }
    ...
    return (
      <View style={styles.container}>
        <View style={styles.viewContainer}>
          ...
          <View style={[styles.fieldContainer, {borderBottomWidth: 2,borderColor: this.state.borderColor}]}>
            ...
            <TextFieldHolder withValue={this.state.text}>
              <TextInput {...this.props}
                ...
                style={[styles.valueText, {color:"#fff"}]}
